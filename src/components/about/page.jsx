...
export default function About() {
  ...
  return (
    <div className="mt-28 max-w-7xl mx-auto px-4 lg:-mt-28" id="about">
      <TitleSection title="About Vink" subtitle="Meet the Tattoo Artist" />
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 -mt-12">
        <div className="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
          ...
          <div className="mt-6 sm:flex sm:min-w-0 sm:flex-1 sm:items-center sm:justify-end sm:space-x-6 sm:pb-1">
            <div className="mt-6 min-w-0 text-gold-500 flex-1 sm:hidden md:block">
      ...
      <div className="relative mt-12 pt-4 isolate mx-auto max-w-7xl grid grid-cols-1 gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-5">
        <svg
